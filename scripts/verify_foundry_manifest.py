...
def verify_local_paths(manifest: dict) -> None:
    ...
    required = [
        ...
        "module/item/validation.mjs",
        "module/creation/creation-engine.mjs",
        "module/compendium/organizer.mjs",
        "module/sheets/lotm-actor-sheet.mjs",
        "module/sheets/lotm-character-sheet.mjs",
        ...
        "templates/sheets/character/character-sheet.hbs",
        "templates/sheets/character/character-header.hbs",
        "templates/sheets/character/character-sidebar.hbs",
        "templates/sheets/item-sheet.hbs",
        "templates/chat/check-card.hbs",
        "templates/chat/info-card.hbs",
        "styles/lotm-character-dnd5e.css",
        "content-src",
        "data",
        "schemas",
